...
// steek logincheck in variabele, data van de $row gebruiker komt hier aan
//, als true is check user, geef bericht en return to steden.
$user = LoginCheck();
if ( $user )
{
    $_SESSION['user'] = $user;
...
function LoginCheck()
{
    if ( $_SERVER['REQUEST_METHOD'] == "POST" )
    {
        ...
        {
            foreach ( $data as $row )
            {// voor elke data in de rij, als passwoord klopt, return de rij
